...
{
    public class BerserkBuff3 : ModBuff
    {
        public override void SetDefaults()
        //Set the defaults of the buff
        {
            DisplayName.SetDefault("Berserk");
            Description.SetDefault("+15% damage. Pay 10% health to deal 5% more damage. Stacks 5 times");
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            player.allDamage = player.allDamage + 0.15f;
        }
    }
}
